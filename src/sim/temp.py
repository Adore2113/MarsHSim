...
def run_thermal_control(state, crew_heat_kw, oga_heat_kw, amine_bed_heat_added_kw, light_heat_kw, wellness_light_heat_kw, gh_heat_kw, gh_led_heat_kw, chx_heat_added_kw, isru_water_heat_added_kw, isru_atm_heat_added_kw, dt_min, sunlight_amount):
    hours_per_step = dt_min / 60.0
    ...
    hab_heat_kw = crew_heat_kw + oga_heat_kw + amine_bed_heat_added_kw + light_heat_kw + wellness_light_heat_kw + chx_heat_added_kw + gh_heat_kw + gh_led_heat_kw + isru_water_heat_added_kw + isru_atm_heat_added_kw
