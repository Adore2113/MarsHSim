...
def co2_scrub_power_and_heat(co2_removed_kpa, bed_online_count, next_time_s, dt_min):
...
def run_co2_scrub(state, co2_after_crew_kpa, next_time_s, dt_min):
    ...
    co2_scrubber_heat_kw, co2_scrubber_heat_kwh, co2_scrubber_power_used_kw, co2_scrubber_energy_used_kwh = co2_scrub_power_and_heat(co2_removed_kpa, beds_online, next_time_s, dt_min)
    return {
