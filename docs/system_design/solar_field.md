...
#### Future Considerations:
    ...
    ♡ consider high-wind automatic panel protection
        - avoid rapid flip/cover cycles
        - avoid unnecessary energy use
        - avoid excessive mechanical wear
        - possibly allow overrides during prolonged low-solar periods
        - require severe wind before protection activates

    ♡ consider cleaning/flipping:
        - duration
        - queue system
        - maximum simultaneous cleanings
        - maintenance availability state
