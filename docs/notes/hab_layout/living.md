# Social and Shared Living Space Layout Plans
### General Notes:
...
### Crew Quarter Interior:
    ...
    ♡ contains:
        ...
        - clothing and personal storage
        - built-in general storage
        - small sitting area
        - entrance into the personal dome
...
### Crew Quarter Dome:
    ...
    ♡ unused utility connections remain covered and sealed when they are not required
...
#### Main Dining Hall:
    ...
    ♡ includes:
        ...
        - serving area
        - space for celebrations / community events

    ♡ can also support meetings / group activities
...
#### Medical Clinic:
    ...
    ♡ medical isolation rooms include: 
        ...
        - entry area for changing protective equipment 
        - digital scenery
        - adjustable lighting
        - communication options to reduce the feeling of confinement 
...
♡ real world size reference:
    ...
    ♡ includes:
        ...
        - storage: ~ 15 m²
        - three large washable worktables
        - adjustable seating
        - sinks / cleanup area
    ...
    ♡ supports:
        ...
        - writing
        - music
        - other personal or group projects

#### Shared Games and Media:
    ♡ a separate game or media room isn't included for V1

    ♡ games and media use existing spaces, including:
        - Shared Living / Social Rooms
        - dining areas when available
        - library
